...
public class NotBitwiseAntExpression extends UnaryAntExpression {

    public NotBitwiseAntExpression() {
        super("~");
    }
    ...
    protected Object eval(float v) {
        throw buildUnexpectedTypeException("float");
    }

    @Override
    protected Object eval(double v) {
        throw buildUnexpectedTypeException("double");
    }
}
